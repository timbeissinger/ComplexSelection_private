---
title: "Analysis of simulated data to test for polygenic selection -- GWAS style (Drift)"
...
**100 QTL in total (10 per chromosome)**
...
Simulations were performed on the IRCF biocluster using QMSim. GAPIT was run on the IRCF biocluster, so the gapit lines are not evaluated in this run.
