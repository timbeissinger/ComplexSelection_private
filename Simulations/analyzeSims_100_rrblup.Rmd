---
title: "Analysis of simulated data to test for polygenic selection -- rrBlup style"
...
Make pretty plots for icqg5
```{r}
png("mapping.png",height=14,width=18,,units="in",res=200,pointsize=18)
